...
<body>
    <div class="thank-you-container">
        ...
        <div class="image-container">
            <img src="image/balayya-thinking-balakrishna-thinking.gif" alt="Thank You GIF">
        </div>

        <!-- Thank You Message -->
        <!-- <h2>Thank You!</h2> -->
        <p>Think about your password once</p>

        <!-- Button to navigate back to home or account page -->
        <a href="login2" class="home-btn" aria-label="Go to Home">login</a>
    </div>
</body>
</html>
